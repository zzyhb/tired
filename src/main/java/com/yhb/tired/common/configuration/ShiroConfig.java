...
import com.yhb.tired.common.pojo.shiro.SystemAuthorizingRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        filter.put("/blogpage/**","anon");
        filter.put("/resource/**","anon");
        filter.put("/editormd/**","anon");
        filter.put("/bootstrap/**","anon");
        ...
        filter.put("/blog/**","anon");//博客内容不进行拦截
        filter.put("/test/**","anon");//测试内容不进行拦截
        //其余接口一律拦截
